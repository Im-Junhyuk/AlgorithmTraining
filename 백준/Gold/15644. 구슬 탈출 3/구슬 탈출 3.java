...
public class Main {
    ...
    static class State{
        ...
        public State(int turn, int rx, int ry, int bx, int by, StringBuilder sb) {
            this.turn = turn;
...
//                    static int[] dy = {1, 0, -1, 0};
                    ...
                    return new Result(cur.turn+1, sb.toString());
                }
                ...
                State add = new State(cur.turn+1, rx, ry, bx, by, sb);
                int hash = visit(add);
    ...
    public static class Result{
        int turn;
        String history;
        public Result(int turn, String history) {
            super();
            this.turn = turn;
